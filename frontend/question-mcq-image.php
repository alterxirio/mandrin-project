...
<head>
    ...
    <title>MCQ Image Question</title>
        ...
        <section class="grid gap-6 lg:grid-cols-[2fr,3fr]">
            <div class="space-y-4">
                <div>
                    ...
                    <input id="mcqInstruction" type="text" placeholder="Contoh: Pilih jawapan yang betul."
                ...
                <div>
                    ...
                    <textarea id="mcqQuestion" rows="5" placeholder="Tulis soalan di sini..."
