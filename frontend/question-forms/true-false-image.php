<div class="space-y-6">
  <header class="space-y-2">
    <h2 class="text-2xl font-semibold text-gray-800">Tambah Soalan Betul / Salah Berdasarkan Gambar</h2>
  ...
  <section class="grid gap-6 lg:grid-cols-[2fr,3fr]">
    <div class="space-y-4">
      <div>
        ...
        <input id="tfInstruction" name="tf_instruction" type="text"
               placeholder="Contoh: Lihat gambar dan tentukan pernyataan betul atau salah."
      ...
      <div>
        ...
        <div class="space-y-2">
          ...
          <input id="tfImageUpload" name="tf_image" type="file" accept="image/*"
                 class="w-full rounded-lg border border-gray-300 bg-gray-50 px-4 py-2 text-sm focus:border-red-500 focus:ring-red-500">
        </div>
      </div>
    ...
    <div class="space-y-4">
      <div>
        ...
        <textarea id="tfStatement" name="tf_statement" rows="5" placeholder="Tulis pernyataan berdasarkan gambar..."
      ...
      <div class="rounded-xl border border-gray-200 p-4 bg-white shadow-sm space-y-3">
        ...
        <div class="flex flex-col gap-2">
          <label class="flex items-center gap-2 text-sm text-gray-600">
            <input type="radio" name="tf_correct" value="true" class="text-red-600 focus:ring-red-500">
            Betul
          </label>
          <label class="flex items-center gap-2 text-sm text-gray-600">
            <input type="radio" name="tf_correct" value="false" class="text-red-600 focus:ring-red-500">
            Salah
          </label>
        </div>
      </div>
